...
if (empty($_GET["user_dni"])   || empty($_GET["user_nom"])   || empty($_GET["user_ape"])   || empty($_GET["user_name"])   || empty($_GET["user_pass"])     )
{
...
//SELECT  CrearVerificarUsuarios ('88888888','NOMBRE_PRUEBA','APE_PRUEBA','USER_NAME','123456')  ;
   $sqlQuery="SELECT  CrearVerificarUsuarios ('".$user_dni."','".$user_nom."','".$user_ape."','".$user_name."','".$user_pass."') as resp   ;";
